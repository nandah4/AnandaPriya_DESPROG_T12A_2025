...
if (!empty($_SESSION['username'])) {
    ...
    if (!empty($_GET['jabatan'])) {
        ...
        $query_anggota = "UPDATE anggota SET nama = '$nama', jenis_kelamin = 
    '$jenis_kelamin', alamat = '$alamat', no_telp = '$no_telp', jabatan_id = '$jabatan' 
    WHERE user_id = '$user_id'";
        ...
        if (mysqli_query($koneksi, $query_anggota)) {
            ...
            password = '$hashed_password', salt = '$salt' WHERE id = '$user_id'";
